...
<div class="flex flex-col gap-6">
    ...
    <div class="flex justify-between items-center">
        ...
        <button class="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity">
        ...
        @forelse($rooms as $room)
            <div class="flex flex-col gap-4 bg-white dark:bg-background-dark/50 border border-gray-200/80 dark:border-gray-700/50 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="flex justify-end gap-2 p-4 border-t border-gray-200/80 dark:border-gray-700/50">
                    <button class="flex items-center justify-center rounded-md h-8 w-8 text-gray-600 dark:text-gray-300 hover:bg-primary/20 dark:hover:bg-primary/30 hover:text-gray-900 dark:hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-xl">visibility</span>
                    </button>
                    <button class="flex items-center justify-center rounded-md h-8 w-8 text-gray-600 dark:text-gray-300 hover:bg-primary/20 dark:hover:bg-primary/30 hover:text-gray-900 dark:hover:text-white transition-colors">
                        <span class="material-symbols-outlined text-xl">edit</span>
                    </button>
                    <button class="flex items-center justify-center rounded-md h-8 w-8 text-red-500 hover:bg-red-500/10 dark:hover:bg-red-500/20 hover:text-red-600 dark:hover:text-red-400 transition-colors">
